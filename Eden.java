...
class Eden extends One{
    ...
    public void play() {
        ...
        System.out.println("-------------------------------------");
        System.out.println("エデン組のだれを調べたいですか？");
        System.out.println("0../オリバー・エバンス");
        System.out.println("1../レイン・パターソン");
        System.out.println("2../レオス・ヴィンセント");
        System.out.println("3../ローレン・イロアス");
        System.out.println("-------------------------------------");
        // 説明文のあるテキストファイルを変数に入れる
        String filePath = "eden.txt";
        try{
