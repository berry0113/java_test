...
class SMC extends One{
    ...
    public void play() {
        ...
        System.out.println("-------------------------------------");
        System.out.println("SMC組のだれを調べたいですか？");
        System.out.println("0../加賀美ハヤト");
        System.out.println("1../葉加瀬冬雪");
        System.out.println("2../夜見れな");
        System.out.println("-------------------------------------");
        // 説明文のあるテキストファイルを変数に入れる
        String filePath = "smc.txt";
        try{
