...
class Ranunculus extends One{
    ...
    public void play() {
        ...
        System.out.println("-------------------------------------");
        System.out.println("ラナンキュラスのだれを調べたいですか？");
        System.out.println("0../天ケ瀬むゆ");
        System.out.println("1../先斗寧");
        System.out.println("2../海妹四葉");
        System.out.println("-------------------------------------");
        // 説明文のあるテキストファイルを変数に入れる
        String filePath = "ranunculus.txt";
        try{
