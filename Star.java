...
class Star extends One{
    ...
    public void play() {
        ...
        System.out.println("-------------------------------------");
        System.out.println("織姫星のだれを調べたいですか？");
        System.out.println("0../フミ");
        System.out.println("1../星川サラ");
        System.out.println("2../山神カルタ");
        System.out.println("-------------------------------------");
        // 説明文のあるテキストファイルを変数に入れる
        String filePath = "star.txt";
        try{
