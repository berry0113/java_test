...
class Voltaction extends One{
    ...
    public void play() {
        ...
        System.out.println("-------------------------------------");
        System.out.println("ボルタクションのだれを調べたいですか？");
        System.out.println("0../四季凪アキラ");
        System.out.println("1../セラフ・ダズルガーデン");
        System.out.println("2../風楽奏斗");
        System.out.println("3../渡会雲雀");
        System.out.println("-------------------------------------");
        // 説明文のあるテキストファイルを変数に入れる
        String filePath = "voltaction.txt";
        try{
