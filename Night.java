...
class Night extends One{
    ...
    public void play() {
        ...
        System.out.println("-------------------------------------");
        System.out.println("夜王国のだれを調べたいですか？");
        System.out.println("0../グウェル・オス・ガール");
        System.out.println("1../白雪巴");
        System.out.println("2../不破湊");
        System.out.println("-------------------------------------");
        // 説明文のあるテキストファイルを変数に入れる
        String filePath = "night.txt";
        try{
