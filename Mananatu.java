...
class Mananatu extends One{
    ...
    public void play() {
        ...
        System.out.println("-------------------------------------");
        System.out.println("まななつのだれを調べたいですか？");
        System.out.println("0../ましろ");
        System.out.println("1../来栖夏芽");
        System.out.println("2../奈羅花");
        System.out.println("-------------------------------------");
        // 説明文のあるテキストファイルを変数に入れる
        String filePath = "mananatu.txt";
        try{
