...
class RedOrganization extends One{
    ...
    public void play() {
        ...
        System.out.println("-------------------------------------");
        System.out.println("赤の組織のだれを調べたいですか？");
        System.out.println("0../えま★おうがすと");
        System.out.println("1../魔使マオ");
        System.out.println("2../ルイス・キャミー");
        System.out.println("-------------------------------------");
        // 説明文のあるテキストファイルを変数に入れる
        String filePath = "red_organization.txt";
        try{
