...
class Ddytica extends One{
    ...
    public void play() {
        ...
        System.out.println("-------------------------------------");
        System.out.println("ディティカのだれを調べたいですか？");
        System.out.println("0../伊波ライ");
        System.out.println("1../小柳ロウ");
        System.out.println("2../星導ショウ");
        System.out.println("3../叢雲カゲツ");
        System.out.println("-------------------------------------");
        // 説明文のあるテキストファイルを変数に入れる
        String filePath = "dytica.txt";
        try{
