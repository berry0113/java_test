...
class Posanke extends One{
    ...
    public void play() {
        ...
        System.out.println("-------------------------------------");
        System.out.println("ぽさんけのだれを調べたいですか？");
        System.out.println("0../天宮こころ");
        System.out.println("1../エリー・コニファー");
        System.out.println("2../ラトナ・プティ");
        System.out.println("-------------------------------------");
        // 説明文のあるテキストファイルを変数に入れる
        String filePath = "posanke.txt";
        try{
