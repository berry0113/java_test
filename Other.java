...
class Other extends One{
    ...
    public void play() {
        ...
        System.out.println("-------------------------------------");
        System.out.println("その他のだれを調べたいですか？");
        System.out.println("0../夢月ロア");
        System.out.println("1../小野町春香");
        System.out.println("2../瀬戸美夜子");
        System.out.println("3../語部紡");
        System.out.println("4../雪城眞尋");
        System.out.println("5../アルス・アルマル");
        System.out.println("6../空星きらめ");
        System.out.println("7../壱百満天原サロメ");
        System.out.println("-------------------------------------");
        // 説明文のあるテキストファイルを変数に入れる
        String filePath = "other.txt";
        try{
